...
countries = ['Argentina', 'Australia', 'Austria', 'Bangladesh', 'Belgium',
             ...
             'Kuwait', 'Lebanon', 'Malawi', 'Malaysia', 'Malta', 'Mauritius',
             'Mexico', 'Mongolia', 'Montenegro', 'Morocco', 'Namibia',
             'Netherlands', 'New Zealand', 'Nigeria',  'Norway', 'Oman',
             'Pakistan', 'Palestine', 'Peru',  'Philippines', 'Poland',
             'Portugal', 'Qatar', 'Romania', 'Russia', 'Rwanda',
             'Saudi Arabia', 'Serbia', 'Singapore', 'Slovenia',
             'South Africa', 'South Korea', 'Spain',  'Sri Lanka', 'Sweden',
             'Switzerland', 'Taiwan', 'Tanzania', 'Tunisia', 'Ukraine',
...
if from_date > to_date:
    ...
    df = consultar_crypto(crypto_select, format_date(
        from_date), format_date(to_date), interval_select)
    try:
